        ...
        def do_GET(self):
            ...
            if path in ("/", "/index.html", "/dashboard.html"):
                ...
                config_data = {
                    ...
                    "CLAUDE_MODEL": getattr(config, "CLAUDE_MODEL", "claude-haiku-4-5-20251001"),
                    "CLAUDE_FALLBACK_MODEL": getattr(config, "CLAUDE_FALLBACK_MODEL", "deepseek/deepseek-v4-flash"),
                    ...
                    "AI_DUAL_SECOND_MODEL": getattr(config, "AI_DUAL_SECOND_MODEL", "Gemini"),
