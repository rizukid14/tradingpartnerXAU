...
- **Dead Zone & Sesi Operasional**: Dead Zone 00:00–07:00 WIB (FX & XAU skip; BTC 24/7); **Night Freeze 23:00–07:00 WIB (pembukaan order FX baru dibekukan, BTC exempt)**; Sesi Tokyo 07:00–14:00 WIB (khusus driver aktif JPY/AUD/NZD, pair Barat locked, lot 1.20x); Sesi London Core 14:00–18:00 WIB (all 26 FX permitted, **lot multiplier 0.75x de-risk cap** guna meratakan asimetri payout 2.9:1); **Sesi New York 18:00–00:00 WIB (flat lot multiplier 0.50x, M3 Breakout Retest dialihkan ke Virtual Paper Trade `SKIPPED_NY_M3_PAPER` untuk pengumpulan sampel $N \ge 60$)**.
