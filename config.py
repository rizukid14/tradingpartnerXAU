...
TRAILING_ACTIVATION_ATR_MULT_XAU = 0.85
...
# XAU (M5 scalper): M30 doang — konteks tren besar. M15 buang: terlalu dekat
# dengan M5 (3x), infonya redundan & bisa konflik sama M30.
HIGHER_TIMEFRAMES = {
