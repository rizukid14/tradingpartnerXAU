...
ENABLE_CSM_FLOW_FILTER = _getenv_bool("ENABLE_CSM_FLOW_FILTER", False)
...
M4_EXTREME_CSM_DELTA_OVERRIDE = _getenv_float("M4_EXTREME_CSM_DELTA_OVERRIDE", 0.035) # CSM Delta override for extreme dealing range
M4_BASING_MIN_BARS = _getenv_int("M4_BASING_MIN_BARS", 3) # Minimal bar kompresi M15/M30 untuk validasi micro-basing
M4_BASING_MAX_RANGE_ATR = _getenv_float("M4_BASING_MAX_RANGE_ATR", 0.35) # Max range bar basing <= 0.35x ATR
M4_DISPLACEMENT_MIN_BODY_PCT = _getenv_float("M4_DISPLACEMENT_MIN_BODY_PCT", 0.50) # Minimal body ratio breakout leg >= 50%
M4_LOOKBACK_SWING_BARS = _getenv_int("M4_LOOKBACK_SWING_BARS", 20) # Jendela deteksi swing high/low yang ditembus
...
MAX_ABSOLUTE_OPEN_POSITIONS = _getenv_int("MAX_ABSOLUTE_OPEN_POSITIONS", 8)
...
ASIA_SESSION_START_HOUR_WIB   = _getenv_int("ASIA_SESSION_START_HOUR_WIB", 6)
...
SESSION_LONDON_LOT_MULT = _getenv_float("SESSION_LONDON_LOT_MULT", 1.00)
...
NIGHT_FREEZE_START_HOUR_WIB           = _getenv_int("NIGHT_FREEZE_START_HOUR_WIB", 22)
...
M5_WINSTREAK_COOLDOWN_COUNT           = _getenv_int("M5_WINSTREAK_COOLDOWN_COUNT", 10)
...
ENABLE_NY_M3_PAPER_ROUTE       = _getenv_bool("ENABLE_NY_M3_PAPER_ROUTE", False) # Route M3 in NY (>= 18 WIB) to Paper Trade
ENABLE_LDN_DEFENSIVE_WINDOW    = _getenv_bool("ENABLE_LDN_DEFENSIVE_WINDOW", False) # London 15-17 sell limit ban
ENABLE_TOKYO_LULL_FREEZE       = _getenv_bool("ENABLE_TOKYO_LULL_FREEZE", False) # Tokyo 10:30-13:00 lull freeze
...
MIDDAY_RETRACEMENT_MAX_PULLBACK_PCT = _getenv_float("MIDDAY_RETRACEMENT_MAX_PULLBACK_PCT", 0.65)
MIDDAY_RETRACEMENT_MIN_PEAK_PTS     = _getenv_int("MIDDAY_RETRACEMENT_MIN_PEAK_PTS", 50)
TOKYO_LULL_MIN_SPRINT_PIPS          = _getenv_float("TOKYO_LULL_MIN_SPRINT_PIPS", 25.0)
PRE_NEWS_EMERGENCY_SHIELD_ENABLED   = _getenv_bool("PRE_NEWS_EMERGENCY_SHIELD_ENABLED", True)
PRE_NEWS_EMERGENCY_MINUTES_BEFORE   = _getenv_int("PRE_NEWS_EMERGENCY_MINUTES_BEFORE", 30)
PRE_NEWS_EMERGENCY_MIN_R            = _getenv_float("PRE_NEWS_EMERGENCY_MIN_R", 0.20)

# --- DIRECTIONAL HYSTERESIS (8 Sep 2026) ---
ENABLE_DIRECTIONAL_HYSTERESIS = _getenv_bool("ENABLE_DIRECTIONAL_HYSTERESIS", False)
DIRECTIONAL_LOCK_HOURS        = _getenv_float("DIRECTIONAL_LOCK_HOURS", 8.0)

# --- ANTI-REVENGE POST-LOSS COOLDOWN ---
POST_LOSS_COOLDOWN_SECONDS   = _getenv_int("POST_LOSS_COOLDOWN_SECONDS", 3600)
...
M3_BASING_BOX_ENABLED = _getenv_bool("M3_BASING_BOX_ENABLED", True)
M3_BASING_MIN_BARS = _getenv_int("M3_BASING_MIN_BARS", 10)
M3_BASING_MAX_BARS = _getenv_int("M3_BASING_MAX_BARS", 48)
M3_BASING_MAX_RANGE_ATR = _getenv_float("M3_BASING_MAX_RANGE_ATR", 1.60)
M3_MEAN_REVERSION_MIN_CSM_DELTA = _getenv_float("M3_MEAN_REVERSION_MIN_CSM_DELTA", 1.50)
M3_MEAN_REVERSION_SL_ATR_MULT = _getenv_float("M3_MEAN_REVERSION_SL_ATR_MULT", 0.35)
...
W1_SECULAR_LOOKBACK_BARS = _getenv_int("W1_SECULAR_LOOKBACK_BARS", 480)
W1_SLOPE_PROXIMITY_TOL_ATR = _getenv_float("W1_SLOPE_PROXIMITY_TOL_ATR", 0.50)
W1_SLOPE_MIN_TOUCHES = _getenv_int("W1_SLOPE_MIN_TOUCHES", 2)
