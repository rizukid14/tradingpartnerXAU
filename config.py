...
def reload_config():
    ...
    global DYNAMIC_CONFIG_ENABLED, FORCE_ACTIVE_ENTRY, DEBATE_ENABLED, QUANT_ANALYSIS_ENABLED, MONTE_CARLO_ENABLED
    ...
    DEBATE_ENABLED = _getenv_bool("DEBATE_ENABLED", DEBATE_ENABLED)
