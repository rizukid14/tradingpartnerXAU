...
- SL Placement: Place SL beyond nearest structural Swing High/Low or S/R level. ATR bounds ({min_sl}-{max_sl} pts) define the valid risk envelope.
- TP Requirement: TP must be at least 1.5x of SL ({min_tp}-{max_tp} pts).
- Confidence Threshold: Confidence >= 0.50 required for BUY/SELL. If edge is weak or market is choppy/unclear, prefer 'HOLD'.
